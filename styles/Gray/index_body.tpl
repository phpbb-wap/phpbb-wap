...
<!-- BEGIN switch_user_logged_out -->
				<div><a href="login.php">登录</a> / <a href="ucp.php?mode=register">注册</a> / <img src="./mods/qqlogin/images/qq_login.png" /><a href="{U_QQ_LOGIN}">QQ登录</a></div>
<!-- END switch_user_logged_out -->
				
<!-- BEGIN switch_user_logged_in -->
				<div class="user-logout"><a href="{U_PEIVATE}">收信箱({UNREAD_PM})</a>|<a href="{U_UCP}">我的地盘</a>|<a href="{U_LOGOUT}">注销登录</a>{DISPLAY_HIDE}</div>
